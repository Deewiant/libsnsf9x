...
extern unsigned long dwSampleRate;
#endif

extern long loInterpolationLevel;
extern long loResampler;
extern unsigned long dwDisableSurround;
extern unsigned long dwReverseStereo;
...
public:
	...
	virtual void SetLong(const wchar_t *name, const long value) throw() = 0;
	virtual long GetLong(const wchar_t *name, const long defaultvalue = 0) throw() = 0;
...
public:
	...
	virtual void SetLong(const wchar_t *name, const long value) throw() { (void)name, value; }
	virtual long GetLong(const wchar_t *name, const long defaultvalue = 0) throw(){ (void)name; return defaultvalue; }
